...
DEFAULT_PORTFOLIO_CONTENT: dict[str, Any] = {
    ...
    "offers": [
        ...
        {
            "kicker": "Offer 04",
            "title": "Photoshop retouching service",
            "description": "Bilingual photo-editing service pages for Vietnam and Australia, with simple pricing, before-after proof, and quote-first lead capture for approachable freelance jobs.",
        },
    ],
    ...
    "projects": [
        ...
        },
        {
            "id": 7,
            "number": "07",
            "name": "Photoshop Retouching Service",
            "audience": "Vietnam and Australia photo-editing clients",
            "desc": "A bilingual Photoshop service landing page with Vietnam/VND and Australia/AUD entry points, simple pricing, before-after sample proof, and a quote-first lead form.",
            "outcome": "Turns Robin's creative editing direction into a focused freelance service without confusing simple Photoshop clients with the full web-development portfolio.",
            "tech": ["HTML", "CSS", "JavaScript", "SEO"],
            "category": "frontend",
            "link": "../photoshop-retouching/vi/",
            "demoLink": "../photoshop-retouching/au/",
            "github": "https://github.com/robinlebnvanh/html-portfolio",
            "date": "Service page",
            "visual": "retouching",
            "linkLabel": "Vietnam page",
            "demoLabel": "Australia page",
        },
    ],
}
